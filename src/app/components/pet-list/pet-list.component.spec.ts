...
describe('PetListComponent', () => {
  ...
  it('should open delete confirmation dialog and call deletePet if confirmed', () => {
    const pet: Pet = {
      id: 1,
      name: 'Shiba',
      status: 'available',
    ...
    expect(petStoreMock.deletePet).toHaveBeenCalledWith(pet.id);
  ...
  it('should open add pet dialog', () => {
    component.openAddPet();
    expect(dialogMock.open).toHaveBeenCalledWith(
      PetFormComponent,
      expect.anything()
    );
  ...
  it('should open edit pet dialog', () => {
    const pet: Pet = {
      id: 2,
      name: 'Husky',
      status: 'pending',
  ...
  it('should open view details dialog', () => {
    const pet: Pet = {
      id: 3,
      name: 'Bulldog',
      status: 'sold',
